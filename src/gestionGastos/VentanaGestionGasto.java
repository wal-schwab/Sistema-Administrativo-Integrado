...
public class VentanaGestionGasto extends VentanaEstandarAplicacion implements ActionListener {
	...
	public VentanaGestionGasto(String legajo, String nombreRol) {
		...
		if(nombreRol.equals("Solo lectura")){
			...
			panel.add(agregarBoton("Eliminar Gasto", 80, 220, 270, 60, 16, false));
		}else {
			panel.add(agregarBoton("Crear Gasto", 80, 90, 270, 60, 16, true));
			panel.add(agregarBoton("Modificar Gasto", 80, 155, 270, 60, 16, true));
			panel.add(agregarBoton("Eliminar Gasto", 80, 220, 270, 60, 16, true));
		}
		panel.add(agregarBoton("Listar Gastos", 80, 285, 270, 60, 16, true));
