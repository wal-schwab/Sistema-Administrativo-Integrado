...
public class VentanaGestionUsuario extends VentanaEstandarAplicacion{
	...
	public VentanaGestionUsuario(String nombreVentana,String nombreUsuario,String apellidoUsuario, String nombreRol) {
		...
		panel.add(agregarBoton("Modificar Usuario", 80, 155, 270, 60, 16, true));
		panel.add(agregarBoton("Eliminar Usuario", 80, 220, 270, 60, 16, true));
		panel.add(agregarBoton("Asignar Rol", 80, 285, 270, 60, 16, true));
