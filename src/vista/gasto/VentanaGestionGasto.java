...
public class VentanaGestionGasto extends VentanaEstandarAplicacion{
	...
	public VentanaGestionGasto(String nombreUsuario,String apellidoUsuario, String nombreRol) {
		super("Gestión de Gastos", nombreUsuario, apellidoUsuario, nombreRol);
