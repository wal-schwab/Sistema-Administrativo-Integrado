...
public class VentanaGestionProveedor extends VentanaEstandarAplicacion implements ActionListener {
	...
	public VentanaGestionProveedor(String legajo, String nombreRol) {
		...
		if(nombreRol.equals("Solo lectura")){
			...
			panel.add(agregarBoton("Crear Proveedor", 80, 90, 270, 60, 16, true));
			panel.add(agregarBoton("Modificar Proveedor", 80, 155, 270, 60, 16, true));
			panel.add(agregarBoton("Eliminar Proveedor", 80, 220, 270, 60, 16, true));
		}
		panel.add(agregarBoton("Listar Proveedores", 80, 285, 270, 60, 16, true));
