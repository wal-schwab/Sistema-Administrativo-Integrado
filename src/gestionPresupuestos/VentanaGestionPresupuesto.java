...
public class VentanaGestionPresupuesto extends VentanaEstandarAplicacion implements ActionListener {
	...
	public VentanaGestionPresupuesto(String legajo, String nombreRol) {
		...
		if(nombreRol.equals("Solo lectura")){
			panel.add(agregarBoton("Crear Presupuesto",  80, 90, 270, 60, 16, false));
			panel.add(agregarBoton("Modificar Presupuesto", 80, 155, 270, 60, 16, false));
			panel.add(agregarBoton("Eliminar Presupuesto", 80, 220, 270, 60, 16, false));
		}else {
			panel.add(agregarBoton("Crear Presupuesto", 80, 90, 270, 60, 16, true));
			panel.add(agregarBoton("Modificar Presupuesto", 80, 155, 270, 60, 16, true));
			panel.add(agregarBoton("Eliminar Presupuesto", 80, 220, 270, 60, 16, true));
		}
		panel.add(agregarBoton("Listar Presupuestos", 80, 285, 270, 60, 16, true));
